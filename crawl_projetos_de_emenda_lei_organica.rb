...
def url_for_page(page)
  "http://mail.camara.rj.gov.br/APL/Legislativos/scpro1316.nsf/Internet/EmendaInt?OpenForm&Start=#{page}"
end
...
File.open("projetos-de-emenda-lei-organica-#{DateTime.now.to_time.to_i}.json", "w") do |f|
